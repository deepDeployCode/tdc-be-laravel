                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-gray-900 dark:text-white">Documentation API</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Welcome to API tdc. Click link <a
                                    href="https://github.com/deepDeployCode/tdc-be-laravel"
                                    target="_blank"><u>here</u></a> for get
                                about
                                documentation API
                            </div>
                        </div>
